	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/unturned-esp/', labelKey: 'homeSeo.linkEsp' },
				{ href: '/unturned-aimbot/', labelKey: 'homeSeo.linkAimbot' },
				{ href: '/unturned-radar-hack/', labelKey: 'homeSeo.linkRadar' },
			],
		},
		{
			...
			links: [
				...
				{ href: '/unturned-hacks/', labelKey: 'homeSeo.linkUndetected' },
		...
		},
		{
			...
			links: [
				...
				{ href: '/unturned-hacks/', labelKey: 'homeSeo.linkUnturnedCheats' },
				{ href: '/features/', labelKey: 'homeSeo.linkAllFeatures' },
			],
		},
		{
