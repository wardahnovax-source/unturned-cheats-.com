 ...
 * Canonical site: https://unturnedhacks.com (matches brand.url)
 *
 * Requires DNS: CNAME `www` → `unturnedhacks.com` (proxied) AND
 * Workers custom domain `www.unturnedhacks.com` attached — otherwise
...
const CANONICAL_HOST = 'unturnedhacks.com';

/** Old apex still 301 → current canonical. */
const LEGACY_HOSTS = new Set(['bestunturnedcheats.com', 'www.bestunturnedcheats.com']);
