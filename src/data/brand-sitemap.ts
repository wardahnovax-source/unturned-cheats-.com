...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		title: 'unturned hacks esp',
		caption: 'unturned hacks esp wallhack',
	},
	{
		src: '/images/unturned-hacks-wallhack.webp',
		title: 'unturned hacks wallhack',
		caption: 'unturned hacks wallhack esp',
	},
	{
		src: '/images/unturned-hacks-aimbot.webp',
		title: 'unturned hacks aimbot',
		caption: 'unturned hacks aimbot soft aim',
	},
	{
		src: '/images/unturned-hacks-aimbot-view.webp',
		title: 'unturned hacks aimbot',
		caption: 'unturned hacks aimbot view',
	},
	{
		src: '/images/unturned-hacks-radar.webp',
		title: 'unturned hacks radar',
		caption: 'unturned hacks radar hack',
	},
	{
		src: '/images/unturned-hacks-session.webp',
		title: 'unturned hacks',
		caption: 'unturned hacks in session',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Unturned', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'unturned-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'unturned-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Unturned on PC' },
