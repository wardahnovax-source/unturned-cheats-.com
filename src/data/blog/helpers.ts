...
const imageMap: Record<BlogImageKey, string> = {
	hero: unturnedImages.espWallhack,
	espWallhack: unturnedImages.espWallhack,
	aimbotCombat: unturnedImages.aimbotCombat,
	aimbotSkeleton: unturnedImages.aimbotSkeleton,
	squadFight: unturnedImages.aimbotCombat,
	headerArt: unturnedImages.playerEsp,
	cheatsPackage: unturnedImages.espWallhack,
	playerEsp: unturnedImages.playerEsp,
	rebootFight: unturnedImages.aimbotCombat,
	battleRoyaleCombat: unturnedImages.cheatsCombat,
	battleRoyaleIslandMap: unturnedImages.espWallhack,
};

const FALLBACK_BLOG_IMAGE = unturnedImages.espWallhack;
...
export function getBlogSitemapEntriesForLocale(locale: LocaleCode) {
	...
	for (const post of blogPosts) {
		...
		const isProductPost = /Unturned Hacks|Aimbot|ESP|Undetected|Comparisons/i.test(post.category);
		entries.push({
