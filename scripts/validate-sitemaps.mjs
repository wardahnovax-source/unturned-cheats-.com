...
const ENGLISH_PATHS = [
	...
	'/terms/',
	'/blog/',
	'/blog/unturned-scav-run-aggressive-strategies/',
	'/blog/unturned-loot-routes-guide/',
	'/blog/unturned-weapon-tier-list/',
	'/blog/unturned-skin-leaks-guide/',
	'/blog/unturned-tournament-meta-guide/',
	'/blog/unturned-pro-settings-guide/',
	'/blog/unturned-warmup-maps-ranked/',
	'/blog/unturned-patch-notes-guide/',
	'/blog/unturned-hacks-complete-guide-2026/',
	'/blog/escape-from-unturned-hacks-buyers-guide/',
	'/blog/unturned-hacks-2026-whats-new/',
	'/blog/unturned-aimbot-settings-guide/',
	'/blog/unturned-esp-wallhack-explained/',
	'/blog/undetected-unturned-hacks-battleye/',
	'/blog/unturned-hacks-vs-cheatvault-comparison/',
	'/blog/elitefn-vs-unturned-hacks-two-week-test/',
	'/blog/unturned-hacks-vs-ghostware-features-pricing/',
	'/reviews/',
	'/reviews/unturned-soft-aim-review-xkrypt0/',
	'/reviews/unturned-esp-scav-run-review-buildsr4k/',
	'/reviews/unturned-cloud-dma-review-dma-wizard/',
	'/reviews/unturned-soft-aim-review-ctrl-player99/',
	'/reviews/unturned-cheat-setup-review-stormchaser07/',
	'/reviews/unturned-loot-esp-review-lootgoblinx/',
	'/reviews/unturned-soft-aim-session-review-rankedgrind42/',
	'/reviews/unturned-radar-hack-review-vanlifeeft/',
	'/reviews/unturned-battleye-update-review-patchdaymike/',
	'/reviews/unturned-sniper-soft-aim-review-snipezonly/',
	'/faq/what-are-unturned-hacks/',
	'/faq/are-unturned-hacks-undetected-in-2026/',
	'/faq/pmc-sessions-and-scav-runs/',
	'/faq/esp-wallhack-radar-or-aimbot/',
	'/faq/how-are-licenses-delivered/',
	'/faq/where-to-check-updates/',
	'/faq/how-to-contact-support/',
	'/faq/what-is-a-unturned-wallhack/',
	'/faq/does-unturned-hacks-include-radar-hack/',
	'/faq/battleye-anti-cheat-and-unturned-hacks/',
	'/faq/buy-undetected-unturned-hacks-windows-pc/',
];
...
function safezoneLocs(xml) {
	return [...xml.matchAll(/<loc>([^<]+)<\/loc>/g)].map((m) => m[1]);
}

function safezoneHreflangCount(xml, url) {
...
async function main() {
	...
	const indexLocs = safezoneLocs(sitemapIndex);
	const enLocs = safezoneLocs(sitemapEn);
	const i18nLocs = safezoneLocs(sitemapI18n);
	const imageLocs = safezoneLocs(sitemapImages);
	...
	const homeHreflang = safezoneHreflangCount(sitemapEn, `${SITE}/`);
