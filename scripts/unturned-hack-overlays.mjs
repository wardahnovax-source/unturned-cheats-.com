/**
 * SVG overlay generators for Unturned hacks marketing images.
 * Composited on top of IGN Unturned gameplay screenshots.
 */
...
export function buildOverlaySvg(width, height, preset) {
	...
	switch (preset) {
		...
		case 'loot':
			...
			body += espBox(width * 0.68, height * 0.52, width * 0.06, height * 0.08, 'player tracker · 103m', '#fbbf24');
