#!/usr/bin/env node
/**
 * Ports the 8 posts from ../unturned-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'unturned-blog', 'src', 'content', 'posts');
const OUT = join(ROOT, 'src', 'data', 'blog', 'posts.generated.ts');

const CATEGORY_NAMES = {
	'battle-royale-meta': 'session Meta',
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'unturned intel'],
...
const file = `/* Auto-generated by scripts/port-from-unturned-blog.mjs — do not edit by hand. */
