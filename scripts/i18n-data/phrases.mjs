...
const KW = {
	...
	cheats: 'unturned hacks',
	hack: 'unturned hack',
	esp: 'unturned esp',
	wallhack: 'ESP wallhack',
	radar: 'radar hack',
	aimbot: 'unturned aimbot',
...
export const phrases = {
	es: {
		buy: 'Comprar Unturned Hacks', undetected: 'indetectables', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'Contacta support@unturnedhacks.com para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Unturned Hacks', undetected: 'indétectables', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'Contactez support@unturnedhacks.com pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Unturned Hacks kaufen', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Unturned Hacks', undetected: 'indetectáveis', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'Contacte support@unturnedhacks.com para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Unturned Hacks', undetected: 'indetectable', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'Contatta support@unturnedhacks.com per supporto o richieste legali.',
	},
	nl: {
		buy: 'Unturned Hacks kopen', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Unturned Hacks', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Unturned Hacks', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Unturned Hacks satın al', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'Destek ve yasal sorular için support@unturnedhacks.com.',
	},
	ar: {
		buy: 'اشترِ Unturned Hacks', undetected: 'غير مكتشف', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Unturned Hacksを購入', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'サポート・法務: support@unturnedhacks.com',
	},
	ko: {
		buy: 'Unturned Hacks 구매', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => '지원 및 법무: support@unturnedhacks.com',
	},
	zh: {
		buy: '购买 Unturned Hacks', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => '支持与法务：support@unturnedhacks.com',
	},
	hi: {
		buy: 'Unturned Hacks खरीदें', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'सहायता: support@unturnedhacks.com',
	},
	id: {
		buy: 'Beli Unturned Hacks', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Unturned Hacks', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Unturned Hacks', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Unturned Hacks', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Unturned Hacks', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Unturned Hacks', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Unturned Hacks', undetected: 'undetected', maps: 'PEI, Washington, and Russia',
		...
		legal: () => 'support@unturnedhacks.com för support och juridik.',
	},
};
