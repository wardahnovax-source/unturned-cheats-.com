...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-unturnedhacks/assets';
...
const USER_SCREENSHOTS = [
	{
		...
		file: 'unturned-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'unturned-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'unturned-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'unturned-aimbot-skeleton.webp',
	},
	{
		source:
	...
	},
	{
		...
		file: 'unturned-hacks-combat.webp',
	},
];
...
const REMOVE_PREFIXES = [
	'unturned-battle-royale-combat',
	'unturned-safezone-fight',
	'unturned-hacks-aimbot',
	'unturned-hacks-cover',
	'unturned-hacks-esp-wallhack',
	'unturned-hacks-hero',
	'unturned-hacks-logo',
	'unturned-hacks-package',
	'unturned-header-art',
	'unturned-loadout-builder',
	'unturned-player-esp',
	'unturned-scav-run-combat',
	'unturned-scav-run-mode',
	'unturned-squad-fight',
	'unturned-verdansk-map',
];

async function removeOldUnturnedImages() {
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'unturned-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `unturned-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'unturned-esp-player-tags.webp') continue;
...
async function generateFavicons() {
	const logoPath = path.join(imagesDir, 'unturned-hacks-logo.png');
